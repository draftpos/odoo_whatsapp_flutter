...
files_to_sync = [
    ('dev_whatsapp_chatbot_ent/tools/send_helpers.py', r'C:\odoo19\addons\dev_whatsapp_chatbot_ent\tools\send_helpers.py'),
...
for remote_rel, local_path in files_to_sync:
    ...
    try:
        ...
        print(f'[OK] Uploaded {remote_rel} to remote server.')
